...
in all-solid-state lithium ion batteries. For example,Li^{0.33}La0.557TiO3(LLTO), Li7La3Zr2O12(LLZO), Li1.3Al0.3Ti1.7(PO4)3(LATP), and Li10GeP2S12(LGPS) are inorganic solid electrolytes. They usually have high lithium ion
